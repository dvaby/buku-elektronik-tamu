    ...
    <div class="p-8 space-y-4">
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div class="bg-yellow-500 px-4 py-3">
                <h3 class="font-semibold text-gray-900 text-sm">Laporan Harian</h3>
            </div>

            <div class="p-4 space-y-4">
                <div class="bg-cyan-50 text-cyan-800 text-sm px-4 py-3 rounded-lg">
                    Data pengunjung yang muncul sesuai dengan hari yang dipilih.
                </div>

                <form method="GET" class="flex flex-wrap items-end gap-2">
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Cari Hari</label>
                    ...
                    <a href="{{ route('laporan.harian.pdf', ['tanggal' => $tanggal]) }}"
                       target="_blank"
