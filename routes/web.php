...
Route::middleware('auth')->group(function () {
    ...
    // Route Buku Tamu (Versi /welcome/form)
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/dashboard/chart-bulan', [DashboardController::class, 'chartBulan'])->name('dashboard.chart-bulan');
        Route::get('/dashboard/chart-tanggal', [DashboardController::class, 'chartTanggal'])->name('dashboard.chart-tanggal');
        Route::get('/dashboard/chart-keperluan', [DashboardController::class, 'chartKeperluan'])->name('dashboard.chart-keperluan');
        Route::get('/informasi-pengguna', [UserManagementController::class, 'informasi'])->name('akun-pengguna.informasi');
        Route::get('/pengunjung', [PengunjungController::class, 'index'])->name('pengunjung.index');
        Route::get('/laporan/harian', [LaporanController::class, 'harian'])->name('laporan.harian');
        Route::get('/laporan/harian/pdf', [LaporanController::class, 'harianPdf'])->name('laporan.harian.pdf');
